...
function MovieList(){
  ...
  {
    "name": "PS2",
    "poster": "https://media-cache.cinematerial.com/p/500x/jzznxfs4/ponniyin-selvan-part-two-indian-movie-poster.jpg?v=1681540612",
 ...
 return (
    ...
    {/* Key name == Prop Name */}
      {movieList.map(({ name, poster,rating,summary }) => (
        <MoviePresentation name={name} poster={poster} rating={rating} summary={summary}/>
      ))}
    </>
  );
